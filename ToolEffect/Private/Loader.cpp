...
HRESULT CLoader::Loading_ForGamePlay()
{
	...
	if (FAILED(pGameInstance->Add_Prototype(LEVEL_GAMEPLAY, TEXT("Prototype_Component_Texture_Snow"),
		CTexture::Create(m_pDevice, m_pContext, TEXT("../../Resources/Textures/Snow/Snow.png")))))
		return E_FAIL;
	...
	if (FAILED(pGameInstance->Add_Prototype(TEXT("Prototype_GameObject_Snow_Red"),
