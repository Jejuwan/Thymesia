...
public:
	/* 렌더타겟을 생성하여 추가하낟. */
	HRESULT Add_RenderTarget(ID3D11Device* pDevice, ID3D11DeviceContext* pContext, const wstring& strTargetTag, _uint iSizeX, _uint iSizeY, DXGI_FORMAT ePixelFormat, const _float4& vClearColor,CRenderTarget::TYPE eType = CRenderTarget::TYPE::RENDER_TARGET);
