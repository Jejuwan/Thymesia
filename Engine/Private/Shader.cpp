...
HRESULT CShader::Bind_UnorderedAccessView(const char* pConstantName, ID3D11UnorderedAccessView* pUAV)
{
	if (nullptr == m_pEffect)
		return E_FAIL;
	...
	ID3DX11EffectUnorderedAccessViewVariable* pUAVVariable = pVariable->AsUnorderedAccessView();
