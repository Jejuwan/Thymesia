	...
	, m_pDeviceContext(nullptr)
{
	...
	m_pDevice->CreateTexture2D(&TextureDesc, , &pTexture2D);*/


	/*ID3D11DepthStencilView*
	ID3D11RenderTargetView*
	ID3D11ShaderResourceView**/
	/*m_pDevice->CreateShaderResourceView(pTexture2D, , &);
	m_pDevice->CreateRenderTargetView(pTexture2D);
	m_pDevice->CreateDepthStencilView(pTexture2D);*/
