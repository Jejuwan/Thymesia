...
private:
	...
	HRESULT Loading_ForGameMapTool();
	HRESULT Loading_ForGamePlay();
	HRESULT Loading_ForBossBat();

	void Load_Model(string strPath);
	void Load_Model_Anim(string strPath);
	void Load_Texture(string strPath);
public:
